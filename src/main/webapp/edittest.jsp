...
<head>
    <meta charset="utf-8">
    <title><fmt:message key="test.edit.title"/></title>
...
<main role="main">
    <div class="jumbotron">
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/edittest?editId=${test.getTestId()}"  method="POST">
                <h2><fmt:message key="test.edit.title"/></h2>
                ...
                <div class="form-group">
                    <label><fmt:message key="test.edit.form.complexity"/>
                ...
                <div class="row mt-3">
                    ...
                    <a href="${pageContext.request.contextPath}/testslist" class="btn btn-block btn-secondary col-6">
                        <fmt:message key="test.edit.backButton"/>
                    </a>
                </div>
            </form>
